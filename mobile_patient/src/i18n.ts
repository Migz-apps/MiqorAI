...
export const translations = {
    en: {
        ...
        qr: {
            ...
            share: 'Share',
            copyId: 'Copy ID',
            shareTitle: 'My MiqorAI QR Code',
            shareMessage: 'Scan this MiqorAI QR code to securely access my medical records',
        },
        family: {
    ...
    fr: {
        ...
        qr: {
            ...
            share: 'Partager',
            copyId: 'Copier l\'ID',
            shareTitle: 'Mon Code QR MiqorAI',
