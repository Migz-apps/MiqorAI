...
export function WelcomeStep({ onNext, onLogin, onRestore, isCompact }: any) {
    return (
        <View className="flex-1 w-full items-center justify-center self-center" style={{ maxWidth: 560 }}>
            ...
            <Text className={cn("mt-xxxl text-text-primary text-[34px] font-[900]", isCompact ? "text-[30px]" : "")}>Med-Pass</Text>
    ...
    return (
        <View className="flex-1 w-full items-center justify-center self-center" style={{ maxWidth: 560 }}>
            ...
            <View className="mt-xxxl w-full">
                <PrimaryButton fullWidth size="lg" onPress={onComplete} isLoading={isLoading}>Start Using Med-Pass</PrimaryButton>
            </View>
        </View>
    )
}
