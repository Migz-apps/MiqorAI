  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "inventory-low": "hsl(var(--inventory-low))",
        primary: {
      ...
      keyframes: {
        ...
        "pulse-ring": {
          "0%": { boxShadow: "0 0 0 0 hsl(var(--pharmacy) / 0.5)" },
          "70%": { boxShadow: "0 0 0 12px hsl(var(--pharmacy) / 0)" },
          "100%": { boxShadow: "0 0 0 0 hsl(var(--pharmacy) / 0)" },
        },
        "scan-line": {
          "0%": { top: "0%" },
          "100%": { top: "100%" },
