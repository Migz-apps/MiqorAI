...
const PAST_REPORTS = [
  ...
  { name: "Adherence outcomes — Q1 2026",     type: "PDF", size: "1.8 MB", date: "2026-04-01", by: "Daniel Njoroge" },
  { name: "Fraud detection summary — Mar 2026", type: "CSV", size: "412 KB", date: "2026-03-31", by: "Brian Otieno" },
  { name: "Savings audit trail — Mar 2026",   type: "CSV", size: "1.1 MB", date: "2026-03-28", by: "Wanjiku Mwangi" },
  { name: "Monthly board report — Feb 2026",  type: "PDF", size: "2.2 MB", date: "2026-03-02", by: "Daniel Njoroge" },
];
...
export default function Reports() {
  ...
  const generate = () => {
    toast.success("Report queued", { description: "We'll email a download link to your inbox in 30 seconds." });
  };
        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent className="space-y-lg">
            ...
            <div>
              ...
              <RadioGroup value={format} onValueChange={(v) => setFormat(v as any)} className="grid grid-cols-3 gap-sm">
                {[
                  { v: "pdf",  label: "PDF",   desc: "Board-ready", icon: FileText },
                  { v: "xlsx", label: "Excel", desc: "Pivots",      icon: FileSpreadsheet },
            ...
            <div className="flex items-center justify-between pt-md border-t">
              ...
              <div className="flex gap-sm">
                ...
                <Button size="sm" onClick={generate} className="gap-sm bg-insurer hover:bg-insurer/90 text-insurer-foreground">
            ...
            <TableBody>
              {PAST_REPORTS.map(r => (
                <TableRow key={r.name}>
                  ...
                  <TableCell className="text-xs num">{r.size}</TableCell>
                  <TableCell className="text-xs">{r.date}</TableCell>
                  <TableCell className="text-xs">{r.by}</TableCell>
                  <TableCell className="text-right">
                    <Button size="sm" variant="ghost" className="h-7 text-xs gap-1 text-insurer">
