...
export type KpiCardProps = {
  ...
  delta?: number;
  deltaLabel?: string;
  /** "up-good" (e.g. savings) — green when positive. "down-good" (e.g. costs) — green when negative. */
...
export const KpiCard = ({ icon: Icon, label, value, delta, deltaLabel, positive = "up-good", accent = "insurer", hint }: KpiCardProps) => {
